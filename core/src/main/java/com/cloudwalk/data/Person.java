...
/**
 * This class implements a person. The shape is based on a design by Artem Nikulchev <jaguart@paragliding.ru> for his paraglider pilot.
 * 
 * A person may appear in various guises - a sailplane pilot, a hang glider pilot, a paraglider pilot...
 * 
 * People are important. People ARE important. They will crop up again and again in Flight Club. The fundamental unit of distance is 0.1 - the height of a
 * person ! Much as architectural drawings have little people in them, our Flight Club models (and unit tests) include people.
 * 
 * The black rectangular obilisk in Stanley Kubrick's film '2001 - a Space Oddessy' is *magical*. People are magical.
 */
public class Person {
	...
	public static Obj3d createPerson(ModelViewer modelViewer) {
		Obj3d obj = new Obj3d(modelViewer);
