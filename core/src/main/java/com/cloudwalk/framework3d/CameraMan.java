...
public class CameraMan {
	...
	private static final int CUT_RAMP = 12; // number of steps we accelerate
											// over during a cut

	// shorten cut length while testing
	private static final int CUT_LEN = 50; // 75; //nos of ticks to glide
	...
	public void init() {
		...
		height = modelViewer.modelView.getHeight();
	 ...
	 *            the subject to film.
	 * @param track
	 *            if true then track the subject as it moves.
	 */
	...
	public float[] getFocus() {
		return new float[] { focus[0], focus[1], focus[2] };
	}
