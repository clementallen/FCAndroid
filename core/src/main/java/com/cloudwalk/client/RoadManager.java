/*
ž * @(#)RoadManager.java (part of 'Flight Club')
 * 
...
class Road {
	XCModelViewer xcModelViewer;
	float[][] ps = new float[100][3]; // list of points that are joined by wires
										// to create the road
	int numPoints = 0;
	...
	void asString() {
		Log.i("FC", "Road:: numPoints: " + numPoints);
	}
