 ...
 * frame. The local frame (i, j, k) will pitch, roll and yaw as the particle
 * moves. This is the class we use to build gliders, cars, jets, birds...
 */
abstract class MovingBody extends Particle {
	...
	/**
	 * Rolls to left or right or returns to level if not currently turning). We
	 * set the roll rate such that after turning thru' 1 radian the roll is at
	 * its max value.
	 */
